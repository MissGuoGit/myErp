...
public class ajax extends HttpServlet {
	...
	protected void saleaddtocarbatch(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(String s:idarray)
        {
        	if(!s.equals("0"))
        	{
        		saleaddtocarsinge(request,response,s);
        	}
        }		
		response.setCharacterEncoding("utf-8");
		response.setContentType("text/json;charset=utf-8");
	...
	protected void saleaddtocarsinge(HttpServletRequest request, HttpServletResponse response,String id) throws ServletException, IOException {
		DBHelper db=new DBHelper();
