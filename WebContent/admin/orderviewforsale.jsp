...
<%
Map<String, Object> orderhead = (Map<String, Object>)request.getAttribute("orderheadforsale");
List<Map<String, Object>> orderitems = (List<Map<String, Object>>)request.getAttribute("orderitemsforsale");
%>
...
<body>
<p class="path">商城后台系统/销售中心/订单明细</p>
...
<tr><td>销售人姓名</td><td style="text-align:left;"><%=orderhead.get("sname")%></td></tr>
<tr><td>联系电话</td><td style="text-align:left;"><%=orderhead.get("stel")%></td></tr>
<tr><td>售卖地址</td><td style="text-align:left;"><%=orderhead.get("saddress")%></td></tr>
